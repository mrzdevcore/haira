...
\input{chapters/11-advanced-features}

% Part III: AI Integration
\part{AI Integration}

\input{chapters/12-ai-integration}
\input{chapters/13-cir-specification}

% Part IV: Implementation
\part{Implementation}

\input{chapters/14-grammar}
\input{chapters/15-compiler-architecture}
